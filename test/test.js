...
wire.remove(true);
console.assert(document.body.childElementCount === 1, 'all nodes but one removed');

document.body.appendChild(wire.valueOf(true));
wire.remove(false);
console.assert(document.body.childElementCount === 0, 'all nodes removed');

wire = new Wire(nodes.slice(1));
document.body.appendChild(wire.valueOf(true));
wire.remove(true);
console.assert(document.body.childElementCount === 1, 'one node removed');

document.body.appendChild(wire.valueOf(true));
wire.remove(false);
console.assert(document.body.childElementCount === 0, 'two nodes removed');
